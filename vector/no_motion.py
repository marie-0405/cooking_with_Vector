...
# node = nep.node("emo_pub" , "nanomsg")
# pub = node.new_pub("emo_facetracking", msg_type)

# sub = node.new_sub("io_emotion", msg_type)
# node = nep.node("emo_pub" , "nanomsg")
# pub = node.new_pub("emo_emosub", msg_type)
...
class Movement():
    ...
    def giggle(self):
        print('giggle')
        self.robot.anim.play_animation('anim_eyecontact_giggle_01_head_angle_40')
    ...
    def lift(self):
        ...
        # self.robot.behavior.set_lift_height(10.0)
    ...
    def thinking(self):
        ...
        # else:
        self.robot.behavior.set_head_angle(degrees(HEAD_ANGLE))
        # self.robot.anim.play_animation('anim_explorer_scan_short_02', ignore_head_track=True, ignore_body_track=True)
        # self.robot.anim.play_animation_trigger('KnowledgeGraphGetIn')
        # time.sleep(1)
